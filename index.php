	...
	if (isset($_SESSION['id'])) {
		...
		<div class='login-screen'>
			...
			<form class='login-form' action='includes/login.inc.php' method='post'>
				...
				<input type='text' class='login-field' name='uid' placeholder='Brugernavn' id='login-name'>
				</div>

				<div class='control-group'>
				<legend>Kodeord:</legend>
				<input type='password' class='login-field' name='pwd' placeholder='kodeord' id='login-pass'>
				</div>
